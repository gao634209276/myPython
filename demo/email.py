...
sent = smtplib.SMTP('smtp.163.com')  # 这一行设置了SMTP服务器为smtp.sina.com
sent.login('18311160051@163.com', 'gao634209276')  # 这里一定注意，填的是独立密码

# 发送邮件
# 刚才我们已经登录了，现在需要设置发送内容，然后发送即可
to = ['18311160051@163.com', '634209276@qq.com']
content = MIMEText(' How do you do?')  # 也就是说，MIMEText的参数代表邮件的具体内容
content['Subject'] = 'test2233'  # 这里设置了邮件标题
content['From'] = '18311160051@163.com'  # 这里设置了邮件从哪里发送
content['To'] = ','.join(to)  # 这里设置了邮件要发送的地址，可以群发
sent.sendmail('18311160051@163.com', to, content.as_string())  # 这一步实现发送邮件，有三个参数，需要注意各自代表什么
sent.close()

# 如何读取邮件
read = poplib.POP3('pop.163.com')
read.user('18311160051@163.com')  # 这里设置登录账号
read.pass_('gao634209276')  # 这里设置登录密码
